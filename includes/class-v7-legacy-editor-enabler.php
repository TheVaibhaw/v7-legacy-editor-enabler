...
class V7_Legacy_Editor_Enabler {
	...
	/** @var V7_Legacy_Editor_Enabler_Loader */
	protected $loader;
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'add_meta_boxes', $plugin_admin, 'add_editor_meta_box' );
		$this->loader->add_action( 'save_post', $plugin_admin, 'save_editor_meta_box' );
	}
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'remove_gutenberg_assets', 100 );
	}
	...
	/** @return V7_Legacy_Editor_Enabler_Loader */
